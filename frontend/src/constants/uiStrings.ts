...
> = {
  en: {
    ...
    asIsHeader: "As-Is",
    toBeHeader: "To-Be",
    asIs1: "Risk of misdiagnosis from\nsubjective visual examination",
    toBe1: "Objective diagnosis via 4-model AI ensemble",
    asIs2: "Blanket high-cost CT/X-ray for every patient",
    toBe2: "First-pass screening with visible-light images,\nselective precision diagnosis based on severity",
    asIs3: "Inefficient bottleneck\n— only specialists can interpret",
